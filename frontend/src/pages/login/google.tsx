    ...
    return (
            <svg width="46px" height="46px" viewBox="0 0 46 46" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                ...
                <g id="Google-Button" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="9-PATCH" transform="translate(-788.000000, -160.000000)"></g>
                    <g id="btn_google_light_disabled"  transform="translate(-1.000000, -1.000000)">
                        <g id="button" transform="translate(4.000000, 4.000000)">
                            <g id="button-bg">
                                <use fill-opacity="0.08" fill="#000000" fill-rule="evenodd"  xlinkHref="#path-1"></use>
